describe('Jumpcut home page UI Test', function () {
    it('Jumpcut home page UI Test', function () {
        ...
        cy.get('.header-phone__link')
            .should('have.attr', 'href', 'tel:213-344-0655')
        // Check for live chat
        cy.get('#chat-widget')
            .should('have.attr','src')
            .should('contain','secure.livechatinc.com')//'#widget-global-6cly8cl8l2x > div > div')
          //.should('contain','Chat with us!')
