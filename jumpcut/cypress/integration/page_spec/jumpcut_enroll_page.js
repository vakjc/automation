describe('Jumpcut enroll page UI Test', function () {
    it('Jumpcut enroll page UI Test', function () {
        ...
        */
        ...
        const app_host = 'eng-232.app.demo.jumpcut.com'
        const host = 'eng-232.demo.jumpcut.com'

        cy.ignore_error()
        cy.clearCookies()
        cy.clearLocalStorage()
        cy.visit('https://' + host + '/enroll/ne9jp9m')
        cy.reload(true)
        cy.location('hostname',{timeout:10000}).should('eq','eng-232.demo.jumpcut.com')
